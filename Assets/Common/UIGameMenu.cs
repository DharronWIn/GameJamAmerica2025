...
namespace Starter
{
	...
	public class UIGameMenu : MonoBehaviour
	{
		...
		public async void StartGame()
		{
			...
			StatusText.text = startArguments.GameMode == GameMode.Single ? "Starting single-player..." : "En attente des joueurs...";
		...
		public async void QuickMatch()
		{
			...
			var startArguments = new StartGameArgs()
			{
				...
				SessionName = $"Room_{Random.Range(1000, 9999)}", // nom aléatoire (sera ignoré si room trouvée)
				PlayerCount = MaxPlayerCount,
