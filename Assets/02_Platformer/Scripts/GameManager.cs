...
namespace Starter.Platformer
{
	...
	public sealed class GameManager : NetworkBehaviour
	{
		...
		public TMP_Text MinCoinsToWinText;
		...
		{
			LocalPlayer = Runner.Spawn(PlayerPrefab[Random.Range(0, PlayerPrefab.Count())], GetSpawnPosition(), Quaternion.identity, Runner.LocalPlayer);
			Runner.SetPlayerObject(Runner.LocalPlayer, LocalPlayer.Object);

			MinCoinsToWinText.text = $"{MinCoinsToWin} a ramasser pour gagner !";
		}
