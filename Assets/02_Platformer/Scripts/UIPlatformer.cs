...
namespace Starter.Platformer
{
	...
	public class UIPlatformer : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			Instructions.text = _lastCoins >= GameManager.MinCoinsToWin ? "Rendez vous a l'orphelinat vite!" : $"Collectés {GameManager.MinCoinsToWin}";
		}
	}
}
